...
function LoginSignUpPage() {
  ...
  return (
    <div className="container mt-5 main_div_update1">
      <div className="row main_div_update">
            ...
            <div className="card-body">
              {loginMode ? (
                <div>
                  ...
                  <p className="mt-3 or_option ">Don't have an account? <button className="btn btn-link p-0" onClick={toggleMode}>Sign Up</button></p>
                </div>
              ) : (
                <div>
                  ...
                  <p className="mt-3 or_option">Already have an account? <button className="btn btn-link p-0" onClick={toggleMode}>Login</button></p>
                </div>
              )}


              <h3 className='or_tag'>---OR---</h3>
              <button className='guest_button' onClick={()=>{guest()}}>Guest</button>
